...
describe('description', function() {
  ...
  it('should report a error for the sample page as there is a spelling mistake', function(done) {
    ...
    var content = fs.readFileSync('./samples/description.wrong.html').toString();
    ...
    testFunc(payload, function(err) {
      ...
      var rule = _.find(
        rules, 
        function(item) { return item.key == 'description'; }
      );
  ...
  // handle the error output
  it('should not report a error on correct description', function(done) {

    // read in the html sample
    var content = fs.readFileSync('./samples/description.right.html').toString();
