...
module.exports = exports = function(payload, fn) {
  ...
  payload.getPageContent(function(err, content) {
    ...
    // loop it all
    $(elementTags.join(',')).each(function(index, elem) {

      // push the item
      spellingTexts.push($(elem).text());
    ...
    spellCheck.check({
        ...
        content:  spellingTexts,
        keywords: uri.hostname.split('.'),
        language: lang
        ...
        for(var i = 0; i < mistakes.length; i++) {
          ...
          var build = payload.getSnippetManager().build(
            ...
            function(line) {
              ...
              return line.toLowerCase().indexOf(mistake.word.toLowerCase()) != -1;
